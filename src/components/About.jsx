const About = () => {
  return (
    <section id="about" className="min-h-screen py-16 px-6 bg-[#1a1a1a]">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 animate-fade-in hover:scale-105 transition-transform duration-300">
          About Me
        </h2>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-up space-y-6">
            <div className="p-6 rounded-lg font-mono text-base border border-gray-800 transition-all duration-500 shadow-2xl" style={{backgroundColor: '#0a0a0a'}}>
